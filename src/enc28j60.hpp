...
#define MAADR4 (0x03 | bank_2_bits | mac_reg_type_bit)
#define MAADR1 (0x04 | bank_2_bits | mac_reg_type_bit)
#define MAADR2 (0x05 | bank_2_bits | mac_reg_type_bit)
#define EBSTSD (0x06 | bank_2_bits | ethernet_reg_type_bit)
#define EBSTCON (0x07 | bank_2_bits | ethernet_reg_type_bit)
#define EBSTCSL (0x08 | bank_2_bits | ethernet_reg_type_bit)
#define EBSTCSH (0x09 | bank_2_bits | ethernet_reg_type_bit)
#define MISTAT (0x0A | bank_2_bits | mac_reg_type_bit)
#define EREVID (0x12 | bank_2_bits | ethernet_reg_type_bit)
#define ECOCON (0x15 | bank_2_bits | ethernet_reg_type_bit)
#define EFLOCON (0x17 | bank_2_bits | ethernet_reg_type_bit)
